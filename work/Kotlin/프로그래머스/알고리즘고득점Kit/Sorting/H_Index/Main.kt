package 프로그래머스.알고리즘고득점Kit.Sorting.H_Index
...
fun main() {
  ...
  validate(
    s.solution(intArrayOf(1, 5, 4, 4, 0)), 3
  )
  ...
  validate(
    s.solution(intArrayOf(3, 3)), 2
  )

  validate(
    s.solution(intArrayOf(100, 100)), 2
  )

  validate(
    s.solution(intArrayOf(0, 0, 0, 0)), 0
  )
