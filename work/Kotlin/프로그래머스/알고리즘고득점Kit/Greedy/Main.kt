...
class Solution {
  ...
  fun solution(n: Int, lost: IntArray, reserve: IntArray): Int {
    ...
    repeat(n) { i ->
      ...
      else if (i + 1 < n && rsvr[i + 1]) check(i + 1)
    }
    return ans
  }
}
 ...
 * ```
 * [ME]
 * 테스트 1 〉	통과 (0.16ms, 59.1MB)
 * 테스트 2 〉	통과 (0.16ms, 59.2MB)
 * 테스트 3 〉	통과 (0.26ms, 59.5MB)
 * 테스트 4 〉	통과 (0.19ms, 59MB)
 * 테스트 5 〉	실패 (0.17ms, 58.9MB)
 * 테스트 6 〉	통과 (0.15ms, 59.4MB)
 * 테스트 7 〉	통과 (0.17ms, 59.1MB)
 * 테스트 8 〉	통과 (0.16ms, 59.1MB)
 * 테스트 9 〉	통과 (0.19ms, 58.3MB)
 * 테스트 10 〉	통과 (0.20ms, 58.8MB)
 * 테스트 11 〉	통과 (0.28ms, 58.4MB)
 * 테스트 12 〉	실패 (0.19ms, 59.3MB)
 * 테스트 13 〉	통과 (0.23ms, 59.2MB)
 * 테스트 14 〉	통과 (0.19ms, 58.9MB)
 * 테스트 15 〉	통과 (0.20ms, 58.7MB)
 * 테스트 16 〉	통과 (0.25ms, 59.5MB)
 * 테스트 17 〉	통과 (0.39ms, 59.3MB)
 * 테스트 18 〉	통과 (0.18ms, 59.5MB)
 * 테스트 19 〉	통과 (0.19ms, 58.4MB)
 * 테스트 20 〉	통과 (0.17ms, 59.6MB)
 * 테스트 21 〉	통과 (0.16ms, 59MB)
 * 테스트 22 〉	통과 (0.18ms, 58.7MB)
 * 테스트 23 〉	통과 (0.15ms, 59.2MB)
 * 테스트 24 〉	통과 (0.34ms, 59.2MB)
 * 테스트 25 〉	통과 (0.17ms, 59.1MB)
 * 테스트 26 〉	통과 (0.16ms, 58.8MB)
 * 테스트 27 〉	통과 (0.17ms, 59.2MB)
 * 테스트 28 〉	통과 (0.17ms, 59MB)
 * 테스트 29 〉	통과 (0.16ms, 59.7MB)
 * 테스트 30 〉	통과 (0.19ms, 59.5MB)
 * ```
 *
 *
 * ```
