package 백준.Silver.no10866

import java.io.BufferedInputStream
import java.io.BufferedOutputStream

private const val IBS = 1 shl 17
private const val OBS = 1 shl 13
...
private val OPReader = IntArray(10)
private fun op(): Int {
  var i = 0
  var b: Int
  while (r().also { b = it.toInt() } in 95..122 || b == 32) {
    if (b == 32) break
    OPReader[i++] = b
  }
  ...
  val c2 = OPReader[1]
  return when {
    c1 == 112 && c2 == 117 -> if (OPReader[5] == 102) PUSH_FRONT else PUSH_BACK
    c1 == 112 && c2 == 111 -> if (OPReader[4] == 102) POP_FRONT else POP_BACK
    c1 == 115 -> SIZE
    c1 == 101 -> EMPTY
    c1 == 102 -> FRONT
    c1 == 98 -> BACK
